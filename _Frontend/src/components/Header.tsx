            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                        <button className="relative flex items-center gap-2 px-3 py-2 bg-black/25 hover:bg-black/35 text-white border border-white/20 rounded-md shadow">
                        ...
                        <button className="flex items-center gap-2 px-3 py-2 bg-white text-indigo-700 hover:bg-indigo-50 border border-white/60 rounded-md shadow">
